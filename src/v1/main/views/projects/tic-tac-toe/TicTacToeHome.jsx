...
class TicTacToeHome extends Component {
    ...
    renderMenu() {
        ...
        if (cleanArr.length >= 4) {
            id = cleanArr[3].toString().toLowerCase();
        }
        if (id === "singleplayer" && cleanArr.length === 4) {
            return <Singleplayer />;
        } else if (id === "ai" && cleanArr.length === 4) {
            return <VsAI />;
        } else if (id === "multiplayer") {
            if (cleanArr.length === 5) {
                return <Multiplayer id={cleanArr[4]} />;
