			...
			<div className="spacing main_container">
				...
				<Card title="About me" className="g-col-6">
					<div>
						...
						<h4>Gaming</h4>
						<p>
							My favorite game to play is Osu, but I also play games such as MapleStory 2, League of Legends, and others. I used to "play" Minecraft,
							though it was mostly server administration and management (probably for 3 years) for multiple servers (longest time spent on a large-ish server for a Youtuber, 15000+ unique visitors before I left).
